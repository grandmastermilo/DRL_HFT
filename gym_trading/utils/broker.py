...
class Broker(object):
    ...
    @property
    def profitable_trade_ratio(self) -> int:
        """
        Ratio of total trades made that were profitable 

        :return: (int) number of executed trades
        """
        return (self.long_inventory.total_profitable_trade + self.short_inventory.total_profitable_trade)/self.total_trade_count
