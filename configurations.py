...
# feature sets
FEATURES_SETS = {
    0:["DISTANCES", "NOTIONAL_VALUES", "NOTIONAL_IMBALANCES", "OFI"],
    1:["NOTIONAL_VALUES", "NOTIONAL_IMBALANCES", "OFI", "I"],
    2:["NOTIONAL_IMBALANCES", "I"],
    3:["NOTIONAL_VALUES", "NOTIONAL_IMBALANCES", "I"],
    4:["NOTIONAL_VALUES", "NOTIONAL_IMBALANCES", "OFI", "I"],
    5:["NOTIONAL_VALUES", "NOTIONAL_IMBALANCES", "OFI", "I"],
    6:["NOTIONAL_VALUES", "NOTIONAL_IMBALANCES", "OFI", "I"],
}
